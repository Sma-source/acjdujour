  ...
  return (
    <div className="w-full lg:grid lg:min-h-[500px] lg:grid-cols-2 xl:min-h-[600px]">
      ...
      <div className="hidden bg-muted lg:block w-full">
        <Image
          src="https://images.unsplash.com/photo-1511974212900-b42a18e19eb8?q=80&w=600&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          alt="Image"
          width="600"
          height="540"
